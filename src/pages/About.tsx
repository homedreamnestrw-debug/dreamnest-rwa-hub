    ...
    <PublicLayout>
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <h1 className="text-4xl lg:text-5xl font-serif mb-6">Crafted with Love in Rwanda</h1>
          <p className="text-lg text-muted-foreground leading-relaxed">
            DreamNest was born from a simple belief — everyone deserves to come home to comfort and beauty.
            Based in Kigali, we curate premium bedding and home decor pieces that blend artisan craftsmanship
